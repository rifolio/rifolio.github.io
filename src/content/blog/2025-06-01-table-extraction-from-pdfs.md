...
cover: /covers/table-extraction.png
coverAlt: Novo Nordisk table extraction project
excerpt: Fine-tuned transformer-based model for automated table extraction with 94% precision.
---
...
`Python` · `PyTorch` · `Transformers` · `Computer Vision` · `Flask` · `Docker` · `OCR`
