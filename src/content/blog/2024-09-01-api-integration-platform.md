...
coverAlt: Focalx API Integration Platform
excerpt: Automated CRM data integration using BERT AI and intelligent schema matching.
---
...
`Python` · `BERT` · `REST API` · `Telegram Bot` · `NLP`

## Impact

Streamlined CRM workflows and reduced manual data entry by 80%.
