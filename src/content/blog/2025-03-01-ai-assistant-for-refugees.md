...
cover: /covers/bevar-ukraine.png
coverAlt: Bevar Ukraine AI assistant for refugees
excerpt: Multilingual AI chatbot on AWS providing 24/7 social support and booking integration.
---
...
`AWS` · `Lambda` · `DynamoDB` · `RAG` · `Telegram` · `WhatsApp` · `Bedrock`
