...
cover: /covers/fruit-flies.png
coverAlt: Statistical analysis of fruit fly fecundity
grade: 12 (Highest grade)
excerpt: Advanced statistical modeling using ANOVA and post-hoc tests for genetic research.
---
...
`Python` · `Statistical Analysis` · `Jupyter Notebook` · `Data Visualization`
