...
`Python` · `Django` · `Next.js` · `DSPy` · `LangChain` · `LangGraph` · `Pinecone` · `PostgreSQL`

## Impact

Shipped a production AI platform for adaptive education with full observability and teacher analytics.
