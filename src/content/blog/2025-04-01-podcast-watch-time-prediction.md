...
cover: /covers/podcast-prediction.png
coverAlt: Podcast watch time prediction
excerpt: ML models predicting podcast engagement using XGBoost and advanced feature engineering.
---
...
`Python` · `XGBoost` · `Optuna` · `Data Science` · `Pandas` · `Scikit-learn`
